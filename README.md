...
**`Graduando em Análise e Desenvolvimento de Sistemas com 5 anos de experiência em TI, atuando como Desenvolvedor Full Stack, Analista de TI e Suporte N3.`**

**`⚙ Principais Competências:`**

**`Desenvolvimento Full Stack: PHP/Laravel, C#, Angular, criação de sistemas web escaláveis.`**

**`Cloud & Banco de Dados: AWS (EC2), MySQL, PostgreSQL, APIs de integração de alta performance.`**

**`Infraestrutura & Segurança: Suporte em redes, firewalls, datacenter, backups e integridade de sistemas.`**

**`Liderança: Coordenação de equipes e gestão de processos de TI.`**
...
<p>
  <img 
    ...
    height="200" 
    style="padding-right: 10px;" 
    src="https://github-readme-stats.vercel.app/api?username=wskilliam&show_icons=true&theme=tokyonight&include_all_commits=true&locale=pt-br" 
  />
<img 
      align="left" 
      alt="GitHub Stats" 
      height="150" 
      src="https://github-readme-stats.vercel.app/api/top-langs/?username=wskilliam&theme=tokyonight&layout=compact&custom_title=Tecnologias&langs_count=9" 
  />
</p>
